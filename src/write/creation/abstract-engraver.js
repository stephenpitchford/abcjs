...
AbstractEngraver.prototype.createBeam = function (isSingleLineStaff, voice, elems) {
	...
	var beamelem = new BeamElem(this.stemHeight * this.voiceScale, this.stemdir, this.flatBeams, elems[0], { alignbeams: this.alignBeams });
...
AbstractEngraver.prototype.addGraceNotes = function (elem, voice, abselem, notehead, stemHeight, isBagpipes, roomtaken) {
	...
	if (elem.gracenotes.length > 1) {
		gracebeam = new BeamElem(stemHeight, "grace", isBagpipes, null, { alignbeams: this.alignBeams });
